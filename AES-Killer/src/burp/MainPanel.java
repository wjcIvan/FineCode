...
//        this.jCheckBox1.setSelected(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            this.myburp.cipher = Cipher.getInstance("AES/CFB/NoPadding");
            byte[][] a = Test.b1();
            this.myburp.sec_key = new SecretKeySpec(a[0],"AES");
            this.myburp.iv_param = new IvParameterSpec(a[1]);
...
//        JOptionPane.showMessageDialog(null, dec_str);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String enc_str = new String(this.jTextArea2.getText());
        if(this.jCheckBox3.isSelected()){enc_str = this.myburp.removeNull(this.myburp.removeOff(enc_str));}
        String dec_str = new String(this.myburp.getSign(enc_str));
        this.jTextArea3.setText(dec_str);
//        JOptionPane.showMessageDialog(null, dec_str);
    }//GEN-LAST:event_jButton4ActionPerformed
