...
{
    public String ExtensionName =  "AESandSign Killer";
    public String TabName = "AESandSign Killer";
    ...
    public void registerExtenderCallbacks(IBurpExtenderCallbacks callbacks)
    {
        ...
        this.stdout.println("AESandSign Killer Installed");
    }
...
//            temp_params = new String (Base64.getEncoder().encodeToString(cipher.doFinal(temp_params.getBytes())));
            temp_params = Test.b("",temp_params);
    ...
    public String doDecrypt(String paramString){
        try{
            ...
            temp_params = Test.a("",temp_params);
//            temp_params = Main.b(temp_params);
