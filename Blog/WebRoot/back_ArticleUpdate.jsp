...
-->
	...
	<jsp:useBean id="articleTypeDao" scope="page" class="com.wjc.dao.ArticleTypeDao"></jsp:useBean>
	<jsp:useBean id="articleDao" scope="page" class="com.wjc.dao.ArticleDao"></jsp:useBean>
	<%
